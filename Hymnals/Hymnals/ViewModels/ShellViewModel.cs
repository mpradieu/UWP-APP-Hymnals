...
namespace Hymnals.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_BookCollection".GetLocalized(), Symbol.Document, typeof(BookCollectionViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_SongCollection".GetLocalized(), Symbol.Document, typeof(SongCollectionViewModel).FullName));
